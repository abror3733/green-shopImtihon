...
// import footer-img1 from "/"
const Footer = () => {
    return (
    <footer className='mt-[100px]'>
<div className='container px-5'>
    <div className='bg-[#FBFBFB] p-4 flex items-center justify-between'>
    ...
    <div className='bg-[#ECF6EE] py-[23px] px-5 flex items-center justify-between'>
        <a href="/">
            <Image src={"/site-logo-footer.svg"} alt='site logo' width={150} height={34}/>
        </a>
                ...
                <ul>
                    ...
                    <div className='flex items-center gap-[10px] mb-[33px]'>
                        ...
                        <a target='_blank' href="https://instagram.com">
                            <Image src={"/instagram-icon.svg"} alt='Instagram' width={30} height={30}/>
                        </a>
                        <a target='_blank' href="https://twitter.com">
                            <Image src={"/x-icon.svg"} alt='Twitter' width={30} height={30}/>
                        </a>
                        <a target='_blank' href="https://linkedin.com">
                            <Image src={"/linkedin-icon.svg"} alt='Linkedin' width={30} height={30}/>
                        </a>
                        <a target='_blank' href="https://union.com">
                            <Image src={"/union-icon.svg"} alt='Union' width={30} height={30}/>
                        </a>
                    </div>
